...
export const mockPermissions = [
  ...
  { code: 'contacts.create', label: 'Create contacts', group: 'Contacts' },
  { code: 'contacts.edit', label: 'Edit contacts', group: 'Contacts' },
  { code: 'contacts.delete', label: 'Delete contacts', group: 'Contacts' },
  { code: 'pipeline.view', label: 'View pipeline', group: 'Pipeline' },
  ...
  { code: 'leads.change_stage', label: 'Change lead stage', group: 'Leads' },
  ...
  { code: 'settings.pipeline.manage', label: 'Manage pipeline stages', group: 'Settings' },
